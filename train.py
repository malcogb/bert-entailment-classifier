...
import wandb
from model import BertClassifier  # Assure-toi que model.py est dans le même dossier
...
def main():
    ...
    for epoch in range(cfg.epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "C:/Users/MSI/Desktop/Deep Learning_2/bert-entailment-classifier/best_model.pt") 
            print(f"Meilleur modèle sauvegardé avec accuracy {best_val_acc:.4f}")
